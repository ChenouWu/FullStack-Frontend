...
import { FaEnvelope, FaLock, FaEye, FaEyeSlash, FaNapster } from "react-icons/fa";
...
function SignUp() {
    ...
    const navigate = useNavigate();
      ...
      const handleSubmit = async (e) => {
        e.preventDefault()
        const response = await axios.post("https://fullstack-backend-1-gnx5.onrender.com/api/users/signUp",{email,password,name});
              ...
              <div>
                  ...
                  <div className="mt-1 relative rounded-md shadow-sm">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <FaNapster className="h-5 w-5 text-gray-400" aria-hidden="true" />
                    </div>
                    <input
                      id="name"
                      name="name"
